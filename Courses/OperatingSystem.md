...
3、  Consider a system that supports the strategies of contiguous, linked, and indexed allocation. What criteria should you use in deciding which strategy is best utilized for a particular file?
